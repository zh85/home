"""Diffusion model training with cross-attention LLM conditioning.

Usage:
    # Standard training (no LLM conditioning)
    python exp_llm_crossattn/diff_train_crossattn.py --dataset mp_20 --epochs 500

    # With LLM conditioning (cross-attention)
    python exp_llm_crossattn/diff_train_crossattn.py --dataset mp_20 --epochs 500 --use_llm_cond
"""
import sys
import os
