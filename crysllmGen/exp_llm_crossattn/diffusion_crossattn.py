"""CrossAttnCSPDiffusion: CSPDiffusion with cross-attention conditioned decoder."""
import torch
...
from exp_llm_crossattn.cspnet_crossattn import CrossAttnCSPNet


class CrossAttnCSPDiffusion(CSPDiffusion):
    """Diffusion model using CrossAttnCSPNet decoder for per-layer cross-attention."""

    def __init__(self, timesteps, run_type, use_llm_cond=True):
        super(CSPDiffusion, self).__init__()

        self.decoder = CrossAttnCSPNet(
            ...
            llm_feat_dim=4096, num_tokens=8,
        )
