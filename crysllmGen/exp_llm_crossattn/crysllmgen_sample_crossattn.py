"""Crystal generation with cross-attention LLM conditioning during diffusion refinement.

Usage:
    python exp_llm_crossattn/crysllmgen_sample_crossattn.py \
...
def main(args):
    ...
    diffusion_model = CrossAttnCSPDiffusion(
    ...
    # Free LLM model and tokenizer to save GPU memory for diffusion
    del model, tokenizer
