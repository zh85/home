"""
LLaMA-3 fine-tuning for crystal material generation (CrysLLMGen).
Adapted from llm_finetune.py to support LLaMA-3-8B.
"""
...
def main(args):
    ...
    print(f"Model: {args.llama_model_path}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--warmup-ratio", type=float, default=0.03,
                        help="Warmup ratio relative to total steps")
    ...
    parser.add_argument("--logging-steps", default=5, type=int,
